        ...
        fields: [
          ...
          // Services section
          {
            ...
            fields: [
              ...
              { type: "string", name: "eyebrow", label: "Section Eyebrow (e.g. 01 · Services)" },
              ...
              { type: "string", name: "body", label: "Introductory Description", ui: { component: "textarea" } },
              {
                ...
                ui: {
                  itemProps: (item) => ({
                    label: (item?.title as string) || "Service Card",
                  }),
                },
                fields: [
          ...
          // Events (featured portfolio) section
          {
            ...
            fields: [
              ...
              { type: "string", name: "eyebrow", label: "Section Eyebrow (e.g. 02 · Flagship Productions)" },
              { type: "string", name: "heading", label: "Section Heading" },
              { type: "string", name: "headingAccent", label: "Heading Accent Word" },
          ...
          // Showreel section
          {
            ...
            fields: [
              ...
              { type: "string", name: "eyebrow", label: "Section Eyebrow (e.g. 03 · Showreel)" },
              { type: "string", name: "heading", label: "Section Heading" },
              { type: "string", name: "headingAccent", label: "Heading Accent Word" },
              { type: "string", name: "openLabel", label: "Watch Showreel Button Text" },
              {
                ...
                ui: {
                  itemProps: (item) => ({
                    label: (item?.title as string) || "Showreel Clip",
                  }),
                },
                fields: [
          ...
          // FAQ section
          {
            ...
            fields: [
              ...
              { type: "string", name: "eyebrow", label: "Section Eyebrow (e.g. 04 · FAQ)" },
              { type: "string", name: "heading", label: "Section Heading" },
              { type: "string", name: "headingAccent", label: "Heading Accent Word" },
              { type: "string", name: "body", label: "Section Description", ui: { component: "textarea" } },
              {
                ...
                ui: {
                  itemProps: (item) => ({
                    label: (item?.question as string) || "FAQ Item",
                  }),
                },
                fields: [
          ...
          // Footer section
          {
            ...
            fields: [
              { type: "string", name: "eyebrow", label: "Section Eyebrow (e.g. 05 · Contact)" },
      ...
      // ── Case Studies ───────────────────────────────────────────
      {
        ...
        fields: [
          ...
          { type: "string", name: "technicalApproach", label: "Technical Approach & Execution Steps", list: true },
          {
            ...
            ui: {
              itemProps: (item) => ({
                label: (item?.step as string) || "Signal Flow Stage",
              }),
            },
            fields: [
          ...
          },
          {
            ...
            ui: {
              itemProps: (item) => ({
                label: (item?.challenge as string) ? `Challenge: ${(item.challenge as string).slice(0, 40)}...` : "Challenge & Solution",
              }),
            },
            fields: [
