...
export function Hero() {
  ...
  return (
    <section
      ...
      className="relative min-h-[88vh] flex flex-col justify-center py-16 sm:py-20 lg:py-24 overflow-hidden bg-tech-grid border-b border-[#162133] scroll-mt-28"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        ...
        <Reveal direction="down" delay={0.1}>
          <div className="inline-flex flex-wrap items-center gap-2.5 px-4 py-2 rounded-full bg-[#0d1421] border border-[#202e47] text-xs font-mono text-slate-200 mb-8 shadow-inner">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            <Reveal direction="up" delay={0.15}>
              <div className="space-y-2">
                <span className="block text-slate-300 text-base sm:text-xl font-mono font-medium tracking-normal">
                  {PERSONAL_INFO.title}
                </span>
            ...
            <Reveal direction="up" delay={0.3}>
              <div className="flex flex-wrap gap-2.5 font-mono text-xs text-slate-200">
                <span className="px-3 py-1.5 rounded-lg bg-[#101827] border border-[#23344e] text-slate-200 flex items-center gap-2">
            ...
            <Reveal direction="up" delay={0.4}>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-8 border-t border-[#182335]">
                <div className="p-4 rounded-2xl bg-[#0c121e] border border-[#1d2a3f]" aria-label="18 plus years of experience">
                ...
                <div className="p-4 rounded-2xl bg-[#0c121e] border border-[#1d2a3f]" aria-label="150 plus major live events">
                ...
                <div className="p-4 rounded-2xl bg-[#0c121e] border border-[#1d2a3f]" aria-label="22 plus broadcasters and channels">
                ...
                <div className="p-4 rounded-2xl bg-[#0c121e] border border-[#1d2a3f]" aria-label="99.99 percent transmission reliability">
          ...
          <div className="lg:col-span-5">
            <Reveal direction="scale" delay={0.25}>
              <div className="relative rounded-3xl bg-[#090e17] border border-[#1e2c42] p-4 sm:p-6 shadow-2xl bevel-panel overflow-hidden space-y-4">
                ...
                <div className="flex items-center justify-between px-3 py-2 bg-[#0d1522] border-b border-[#1b283d] rounded-xl text-xs font-mono">
                ...
                <div className="relative aspect-video bg-[#04060a] rounded-2xl overflow-hidden border border-[#1a2538] flex flex-col justify-between p-5" aria-live="polite">
                  {/* Scanline overlay */}
                  ...
                  <div className="relative z-10 flex items-start justify-between">
                    <div>
                      <div className="inline-block px-2.5 py-1 rounded bg-red-950/90 border border-red-600 text-red-300 text-[11px] font-mono font-bold tracking-wider mb-1.5">
                    ...
                    {/* VU Meter simulation */}
                    <div className="bg-[#0b1019]/90 border border-[#1d2b40] p-2.5 rounded-xl flex flex-col items-center gap-1 font-mono text-[10px]">
                  ...
                  {/* Bottom Bar: Status */}
                  <div className="relative z-10 flex items-center justify-between text-[11px] font-mono text-slate-200 pt-2.5 border-t border-slate-800/80">
                    <span>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5" role="group" aria-label="Select multiviewer camera angle">
                  {simulatedFeeds.map((feed) => {
                    ...
                    return (
                      <button
                        ...
                        className={`p-3 rounded-xl border text-left font-mono transition-all bevel-button min-h-[56px] focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:outline-none flex flex-col justify-between ${
                          isSelected
                ...
                <div className="flex items-center justify-between px-2 pt-1 text-[10px] font-mono text-slate-400">
                  ...
                  <span className="text-amber-400 font-medium">INTERACTIVE BUS SELECTOR</span>
                </div>
              </div>
            </Reveal>
          </div>
