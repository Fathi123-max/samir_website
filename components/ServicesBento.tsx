...
export function ServicesBento() {
  ...
  return (
    <section
      ...
      className="py-20 lg:py-28 bg-[#070b12] border-b border-[#162133] relative overflow-hidden scroll-mt-28"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {SERVICES.map((service, index) => {
            ...
            return (
              ...
              >
                <div className="h-full p-6 sm:p-8 rounded-3xl bg-[#0c121e] border border-[#1b283d] hover:border-amber-500/50 transition-all duration-300 flex flex-col justify-between group shadow-xl bevel-panel space-y-6">
                  <div>
                    {/* Top Header */}
                    <div className="flex items-center justify-between mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-[#131d2e] border border-[#24354f] flex items-center justify-center text-amber-400 group-hover:scale-105 group-hover:border-amber-500/60 transition-all shrink-0">
                        <Icon className="w-7 h-7" aria-hidden="true" />
                      </div>
                      <span className="text-[11px] font-mono px-3 py-1.5 rounded-lg bg-[#070a10] border border-[#1a2538] text-slate-300 font-semibold">
                        {service.metrics}
                      </span>
                    </div>
